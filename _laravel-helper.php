...
namespace {
    ...
    class Auth extends \App\Facades\AuthFacade{
        ...
        public static function check(){
            return \App\Managers\PhoenixAuthManager::check();
        }
         ...
         * @static
         */
        public static function attempt($where){
            return \App\Managers\PhoenixAuthManager::attempt($where);
        }

        /**
         *
         *
         * @param \App\Managers\Model $user
         * @return bool
         * @static
         */
        public static function login($user){
            return \App\Managers\PhoenixAuthManager::login($user);
        }

        /**
         *
         *
         * @return NULL|\App\Managers\Model
         * @static
         */
        public static function user(){
            return \App\Managers\PhoenixAuthManager::user();
        }
        ...
        public static function logout(){
            return \App\Managers\PhoenixAuthManager::logout();
        }
    ...
    class DSVLogger extends \Phoenix\DSV\Facades\DSVLogger{
         ...
         */
        public static function info($message, $context = array()){
            return \Phoenix\DSV\Log\Logger::info($message, $context);
        }
        ...
        public static function warn($message, $context = array()){
            return \Phoenix\DSV\Log\Logger::warn($message, $context);
        }
        ...
        public static function err($message, $context = array()){
            return \Phoenix\DSV\Log\Logger::err($message, $context);
        }
         ...
         */
        public static function alert($message, $context = array()){
            return \Phoenix\DSV\Log\Logger::alert($message, $context);
        }
        ...
        public static function crit($message, $context = array()){
            return \Phoenix\DSV\Log\Logger::crit($message, $context);
        }
         ...
         * @static
         */
        public static function log($msg, $code, $info = array()){
            return \Phoenix\DSV\Log\Logger::log($msg, $code, $info);
        }

    }


    class DSVMailer extends \Phoenix\DSV\Facades\DSVMailer{
         ...
         * @static
         */
        public static function crit($subject, $message){
            return \Phoenix\DSV\Service\Mailer::crit($subject, $message);
        }
         ...
         * @static
         */
        public static function err($subject, $message){
            return \Phoenix\DSV\Service\Mailer::err($subject, $message);
        }
         ...
         * @static
         */
        public static function warn($subject, $message){
            return \Phoenix\DSV\Service\Mailer::warn($subject, $message);
        }

    }


    class PersonValidator extends \App\Facades\PersonValidator{

        /**
         *
         *
         * @param \App\Http\Controllers\Basics\Person $person
         * @static
         */
        public static function setPerson($person){
            return \App\Http\Controllers\Basics\PersonControllerHelper::setPerson($person);
        }
         ...
         * @static
         */
        public static function validate($validation = null){
            return \App\Http\Controllers\Basics\PersonControllerHelper::validate($validation);
        }
         ...
         * @static
         */
        public static function getDefaultValidation(){
            return \App\Http\Controllers\Basics\PersonControllerHelper::getDefaultValidation();
        }
         ...
         * @static
         */
        public static function validatePerson($validation = array()){
            //Method inherited from \App\Validator\BasicValidator
            return \App\Http\Controllers\Basics\PersonControllerHelper::validatePerson($validation);
        }
        ...
        public static function setRequest($request){
            //Method inherited from \App\Validator\BasicValidator
            return \App\Http\Controllers\Basics\PersonControllerHelper::setRequest($request);
        }

        /**
         *
         *
         * @return \App\Validator\Request
         * @static
         */
        public static function getRequest(){
            //Method inherited from \App\Validator\BasicValidator
            return \App\Http\Controllers\Basics\PersonControllerHelper::getRequest();
        }

    }


    class SemTNValidator extends \App\Facades\SemTNValidator{
        ...
        public static function validate(){
            return \App\Validator\SeminarTeilnehmerValidator::validate();
        }
        ...
        public static function validateDetails(){
            return \App\Validator\SeminarTeilnehmerValidator::validateDetails();
        }
        ...
        public static function validatePerson($validation = array()){
            //Method inherited from \App\Validator\BasicValidator
            return \App\Validator\SeminarTeilnehmerValidator::validatePerson($validation);
        }
        ...
        public static function setRequest($request){
            //Method inherited from \App\Validator\BasicValidator
            return \App\Validator\SeminarTeilnehmerValidator::setRequest($request);
        }
        ...
        public static function getRequest(){
            //Method inherited from \App\Validator\BasicValidator
            return \App\Validator\SeminarTeilnehmerValidator::getRequest();
        }
    ...
    class Flash extends \App\Facades\FlashFacade{
         ...
         * @static
         */
        public static function info($message, $dest = 'global'){
            return \App\Http\Phoenix\Helper\Flash\Notifier::info($message, $dest);
        }
         ...
         * @static
         */
        public static function message($message, $dest = 'global', $level = 'info'){
            return \App\Http\Phoenix\Helper\Flash\Notifier::message($message, $dest, $level);
        }
         ...
         * @static
         */
        public static function success($message, $dest = 'global'){
            return \App\Http\Phoenix\Helper\Flash\Notifier::success($message, $dest);
        }
         ...
         * @static
         */
        public static function error($message, $dest = 'global'){
            return \App\Http\Phoenix\Helper\Flash\Notifier::error($message, $dest);
        }
         ...
         * @static
         */
        public static function warning($message, $dest = 'global'){
            return \App\Http\Phoenix\Helper\Flash\Notifier::warning($message, $dest);
        }
         ...
         * @static
         */
        public static function getMessage($dest = 'global', $level = 'info'){
            return \App\Http\Phoenix\Helper\Flash\Notifier::getMessage($dest, $level);
        }
